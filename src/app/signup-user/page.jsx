...
export default function SignupUserPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      setLoading(false);
      return alert(
        "Please complete First Name, Last Name, Contact Number, and Location."
      );
    }
    ...
    if (!phoneRegex.test(contactNumber.trim())) {
      setLoading(false);
      return alert(
        "Contact number must start with +639 and be followed by 9 digits."
      );
    }
    ...
    try {
      ...
      if (!existingUser) {
        const locationString = `Lat:${coordinates.lat},Lng:${coordinates.lng}`;
    ...
    <div className="min-h-screen bg-[#F4F3ED] px-4 py-10">
      <div className="max-w-[1200px] mx-auto grid gap-8 lg:grid-cols-[1fr_1.2fr] items-center">
        <div className="rounded-[32px] border border-slate-200 bg-white p-10 shadow-sm">
          <div className="mb-6">
            <p className="text-sm uppercase tracking-[0.4em] font-semibold text-[#E23838]">
              Food Lover Signup
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-slate-600">
                  ...
                  <button
                    ...
                    className="font-semibold text-[#E23838] underline"
                  >
                    privacy policy
                  </button>
                  .
                  ...
                  <div className="space-y-6 overflow-y-auto p-8" style={{ maxHeight: "calc(90vh - 96px)" }}>
                    ...
                    <section className="rounded-[28px] border border-slate-200 p-6 shadow-sm">
                      ...
                      <p className="text-slate-700 leading-7">
                        We use your information to create and manage your account, deliver MenuQR services, remember your preferences, and improve the app experience. Your data helps power saved menus, personalized suggestions, and secure user access.
                      </p>
                    </section>
                    ...
                    <div className="grid gap-4 lg:grid-cols-2">
                      <section className="rounded-[28px] border border-slate-200 p-6 shadow-sm">
                        ...
                        <p className="text-slate-700 leading-7">
                          Your information is stored securely in Supabase with industry-standard safeguards and restricted access.
                        </p>
                      </section>
                      <section className="rounded-[28px] border border-slate-200 p-6 shadow-sm">
                        <h3 className="text-xl font-semibold text-slate-900 mb-3">Sharing & Third Parties</h3>
                        <p className="text-slate-700 leading-7">
                          We do not sell your data. We only share information with trusted service providers required to operate MenuQR.
                        </p>
                      </section>
                    </div>
                    ...
                    <section className="rounded-[28px] border border-slate-200 bg-slate-50 p-6 shadow-sm">
                      ...
                      <p className="text-slate-700 leading-7">
                        ...
                        <a href="mailto:projectmenuqr@gmail.com" className="font-semibold text-[#E23838] underline">
                          projectmenuqr@gmail.com
                        </a>.
                      </p>
                    </section>
                  </div>
