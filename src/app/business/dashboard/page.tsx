              ...
              <main className="space-y-8">
                ...
                <section className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div className="rounded-[24px] bg-gradient-to-br from-[#E23838] to-[#c22f2f] text-white p-4 sm:p-5 shadow-sm hover:shadow-md transition min-h-[150px]">
                    ...
                    <div className="rounded-[24px] bg-gradient-to-br from-[#F2FF00] to-[#d4cc00] text-slate-900 p-4 sm:p-5 shadow-sm hover:shadow-md transition min-h-[150px]">
                    ...
                    <div className="rounded-[24px] bg-gradient-to-br from-emerald-500 to-emerald-700 text-white p-4 sm:p-5 shadow-sm hover:shadow-md transition min-h-[150px]">
                      <p className="text-[11px] sm:text-xs font-medium text-white/80">
                        Today's Orders
                      </p>
                      <p className="text-2xl sm:text-3xl font-black mt-3">
                ...
                <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-sm mt-12">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                    <a
                      href="/business/menu"
                      className="rounded-[20px] bg-[#E23838] text-[#F2FF00] font-semibold text-sm px-4 py-3 text-center hover:bg-[#c22f2f] transition shadow-sm"
                    >
                      Manage Menu
                    </a>
                    ...
                    <a
                      ...
                      className="rounded-[20px] bg-[#F2FF00] text-slate-900 font-semibold text-sm px-4 py-3 text-center hover:bg-[#d4cc00] transition shadow-sm"
                    >
                      View Orders
                    </a>
