...
import { fetchActiveOrderByTable, OrderData } from "@/utils/fetchActiveOrder";
...
export default function BusinessPage() {
  ...
  const orderStatus: OrderStatus = (currentOrder?.status as OrderStatus) ?? "none";
  ...
  const handleSubmitOrder = async () => {
    ...
    if (!business || !tableId || !sessionId) return;
